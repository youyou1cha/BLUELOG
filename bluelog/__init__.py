...
from bluelog.extensions import bootstrap, db, login_manage, csrf, ckeditor, mail,toolbar, moment, migrate
...
def register_commands(app):
    ...
    @app.cli.command()
    @click.option('--username', prompt=True, help='The username userd to log')
    ...
    def init(username, password):
        ...
        if admin is not None:
            click.echo('The administroator already exists ,updating..')
            admin.username = username
            admin.set_passwor(password)
        else:
            click.echo('Creating the temporary administroator account...')
            admin = Admin(
                username=username,
                blog_title='Bluelog',
    ...
    def forge(category, post, comment):
        ...
        click.echo('Generating %d commands...' % comment)
